// Author: Elin.Liu
// Date: 2022-10-03 22:15:46
// Last Modified by:   Elin.Liu
// Last Modified time: 2022-10-03 22:15:46
//  Author: Elin.Liu
...
/*
    ...
    并返回完整的缓存路径，类型为字符串指针
    例如：getCacheFileDir("C:\Users\{Sys User}\Documents\WeChat Files\wxid_{cache_user_id}")
*/
char *getCacheFileDir(char *path)
{
    DIR *wechat_cache_dir = opendir(path);
    struct dirent *cache_dir;
    char endPath[100] = "\\FileStorage\\File";
    int i = 0;
