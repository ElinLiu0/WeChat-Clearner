// Author: Elin.Liu
// Date: 2022-10-13 14:33:50
// Last Modified by:   Elin.Liu
// Last Modified time: 2022-10-13 14:33:50
...
/*
    ...
    并返回完整的缓存路径，类型为字符串指针
    例如：getCacheVideoDir("C:\Users\{Sys User}\Documents\WeChat Files\wxid_{cache_user_id}")
*/
char *getCacheVideoDir(char *path)
{
    DIR *wechat_cache_dir = opendir(path);
    struct dirent *cache_dir;
    char endPath[100] = "\\FileStorage\\Video";
    int i = 0;
